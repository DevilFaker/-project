            ...
            <div class="container">
                ...
                <div class="col-md-9" id="checkout">
                    ...
                    <div class="box">
                            ...
                            <div class="content">
                                <div class="row">
                                    <div class="col-sm-6" onclick="add(10)">
                                        <div class="box shipping-method">
                                            ...
                                            <div class="box-footer text-center">
                                                ...
                                                <input type="radio" name="delivery" value='10'  checked="checked">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6" onclick="add(15)">
                                        <div class="box shipping-method">
                                            ...
                                            <div class="box-footer text-center">
                                                ...
                                                <input type="radio" name="delivery" value="15" onclick="add(this.value)">
                                            </div>
                                        </div>
                                    </div>

                                    <div class="col-sm-6" onclick="add(40)">
                                        <div class="box shipping-method">
                                            ...
                                            <div class="box-footer text-center">
                                                ...
                                                <input type="radio" name="delivery" value="40" onclick="add(this.value)">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="box-footer">
                                ...
                                <div class="pull-right">
                                    <button onclick='ship()' class="btn btn-primary">Continue to Payment Method<i class="fa fa-chevron-right"></i>
                                    </button>
                                </div>
                            </div>
...
?>
                            ...
                            <table class="table">
                                <tbody>
                                    <tr>
                                        ...
                                        <th>$<span><?php echo $subtotal[0]; ?></span></th>
                                    </tr>
                                    <tr>
                                        <td>Shipping and handling</td>
                                        <th>$<span id='ship'></span></th>
                                    </tr>
                                    <tr>
                                        <td>GST 10%</td>
                                        <th>$<span><?php echo $tax[0]; ?></span></th>
                                    </tr>
                                    <tr class="total">
                                        <td>Total</td>
                                        <th>$<span id='totalmonry'><?php echo $total[0]; ?></span></th>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
  ...
  <script type="text/javascript">
    var x=<?php echo $total[0]; ?>;
    x=parseInt(x);
    value=10;
    x = x + value;
    document.getElementById('ship').innerHTML=10;
    document.getElementById('totalmonry').innerHTML=x;
 ...
 function add(value){
    var a=<?php echo $total[0]; ?>;
    a=parseInt(a);
	value=parseInt(value);
    a = a + value;
    document.getElementById('ship').innerHTML=value;
    document.getElementById('totalmonry').innerHTML=a;
