                        ...
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked category-menu">
                                <li class="active">
                                    ...
                                    <ul>
                                        <li ><a href="category-man-tshirt.php">T-shirts<span class="badge pull-right">5</span></a>
                                        </li>
                                        <li><a href="category-man-shirt.php">Shirts<span class="badge pull-right">3</span></a>
                                        </li>
                                        <li><a href="category-man-pants.php">Pants<span class="badge pull-right">2</span></a>
                                        </li>
                                        <li><a href="category-man-Accessories.php">Accessories<span class="badge pull-right">3</span></a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="category.php">Ladies  <span class="badge pull-right">15</span></a>
                                    <ul>
                                        <li><a href="category-lady.php-tshirt">T-shirts<span class="badge pull-right">4</span></a>
                                        </li>
                                        <li><a href="category-lady.php-shirt">Shirts<span class="badge pull-right">5</span></a>
                                        </li>
                                        <li><a href="category-lady.php-pant">Pants<span class="badge pull-right">3</span></a>
                                        </li>
                                        <li><a href="category-lady.php-Accessories">Accessories<span class="badge pull-right">3</span></a>
                                        </li>
                                    </ul>
                                </li>
								<!--
