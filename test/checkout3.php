        ...
        <div id="content">
            <div class="container">
                ...
                <div class="col-md-9" id="checkout">
                    ...
                    <div class="box">
                        <form method="POST" action="userdetail3.php">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="box payment-method">
                                            ...
                                            <div class="box-footer text-center">
                                                ...
                                                <input type="radio" name="payment" value="1" onclick='pay(this.value)' checked="checked">
                                            </div>
                                        </div>
                                    </div>
<?php
     ...
     while (oci_fetch_array($stmt)){
				 ...
				 if($address[0]!==''){ */
                 $cardname[$i]=oci_result($stmt,'CARDNAME');
                 $cardnumber[$i]=oci_result($stmt,'CARDNUMBER');
                 
                 $expirymonth[$i]=oci_result($stmt,'EXPIRYMONTH');
                 $expiryyear[$i]=oci_result($stmt,'EXPIRYYEAR');
                 $cvv[$i]=oci_result($stmt,'CVV');
...
?>	 
                                        ...
                                        <div class="box payment-method">
											...
											<div class="row">
											  <div class="col-sm-10 form-group">
												<input type="text" name="cardname" placeholder="Name On Card" value='<?php echo $cardname[0] ?>' onkeyup="checkinfo(this.value,8)  class="form-control"  >
												<p id='q' color="red"></p>
											  </div>
											  <div class="col-sm-10 form-group">
												<input type="text" name="cardnumber" placeholder="Card Number" value='<?php echo $cardnumber[0] ?>' onkeyup="checkinfo(this.value,9)" maxlength="14"  class="form-control" >
												<p id='w' color="red"></p>
											  </div>
											  <div class="col-sm-4 form-group">
												<input type="text" name="expirymonth" placeholder="Expiry Month" value='<?php echo $expirymonth[0] ?>' onkeyup="checkinfo(this.value,10)"  class="form-control" >
												<p id='e' color="red"></p>
											  </div>
											  <div class="col-sm-4 form-group">
												<input type="text" name="expiryyear" placeholder="Expiry Year" value='<?php echo $expiryyear[0] ?>' onkeyup="checkinfo(this.value,11)"  class="form-control" >
												<p id='r' color="red"></p>
											  </div>
											  <div class="col-sm-4 form-group">
												<input type="text" name="cvv" placeholder="CVV" maxlength="3" value='<?php echo $cvv[0] ?>' onkeyup="checkinfo(this.value,12)"  class="form-control" >
												<p id='t' color="red"></p>
											  </div>
											...
											<div class="box-footer text-center">
                                                ...
                                                <input type="radio" name="payment" value="2" onclick="pay(this.value)">
                                            </div>
     ...
     $connect=oci_connect("liteng", "Li86459451","SSID");
	  ...
	  oci_execute($stmt);
	  while(oci_fetch_array($stmt)){ $i++;  }
     $sql="select * from ORDERSUMMAY where email='{$username}' and order_id='{$i}'" ;
     $stmt=oci_parse($connect, $sql);
     oci_execute($stmt);
	 ...
	 while(oci_fetch_array($stmt)){
	             ...
	             $subtotal[$i]=oci_result($stmt,'ORDERSUBTOTAL');
				 $tax[$i]=oci_result($stmt,'SHIPPING');
				 $total[$i]=oci_result($stmt,'TOTAL');
				 $ship[$i]=oci_result($stmt, 'SHIP');
				 $i++;
                            ...
                            <table class="table">
                                <tbody>
                                    <tr>
                                        ...
                                        <th>$<?php echo $subtotal[0]; ?></th>
                                    </tr>
                                    <tr>
                                        <td>Shipping and handling</td>
                                        <th>$<span id='ship'><?php echo $ship[0]; ?></span></th>
                                    </tr>
                                    <tr>
                                        <td>GST 10%</td>
                                        <th>$<?php echo $tax[0]; ?></th>
                                    </tr>
                                    <tr class="total">
                                        <td>Total</td>
	...
	*/
	 function checkinfo(text,type){
		...
		var  success=function(respond) {
			...
			if (respond==51){document.getElementById("postcodesuggestion").innerHTML="6 number only";}
