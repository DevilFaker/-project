                    ...
                    <div class="box">
                        ...
                        <form method="post" action="doAction.php?act=reg" > 
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="firstname" name="username" onkeyup ="checkinfo(this.value,1)" required>
                                <p id="firstnamesuggestion"></p>
                            </div>
                            <div class="form-group">
                                <label for="email">Email *</label>
                                <input type="text" class="form-control" id="email" name="email"  onkeyup ="checkinfo(this.value,7)" required>
                                <p id="emailsuggestion" color="red"></p>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-primary" id="o" ><i class="fa fa-user-md"></i> Register</button>
                            </div>
                        </form>
                    </div>
                </div>
...
function checkinfo(text,type){
		...
		var  success=function(respond) {
			...
			if (respond==51){document.getElementById("postcodesuggestion").innerHTML="6 number only";document.getElementById("o").disabled=true;}
