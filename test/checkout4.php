            ...
            <div class="navbar-header">
                ...
                <div class="navbar-buttons">
                    ...
                    <a class="btn btn-default navbar-toggle" href="basket.php">
                        <i class="fa fa-shopping-cart"></i>  <span class="hidden-xs"><?php echo $i; ?> </span>items in cart
                    </a>
                </div>
            </div>
            <!--/.navbar-header -->
            ...
            <div class="container">
                ...
                <div class="col-md-9" id="basket">
                    ...
                    <div class="box">
                            ...
                            <h1>Shopping cart</h1>
                            <p class="text-muted">You currently have<?php echo $e;?>item(s) in your cart.</p>
         ...
         ?>                                   
                            ...
                            <div class="box-footer">
                                ...
                                <div class="pull-right">
                                    <button class="btn btn-default" onclick='window.location.reload();'><i class="fa fa-refresh"></i> Update basket</button>
                                    <button type="submit" class="btn btn-primary" onclick="order()">Place an order<i class="fa fa-chevron-right"></i>
                                    </button>
                                </div>
                            </div>
