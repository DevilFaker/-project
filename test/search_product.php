                    ...
                    <div class="modal-body">
                        <form action="doAction.php?act=login" method="post">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="username" id="email-modal" placeholder="email" required>
...
<div>
    <div class="col-sm-12 ">
         ...
         <strong > PLEASE LOG IN BRFORE SHOPPING</strong>                       
    </div>
</div>	
 ...
 _________________________________________________________ -->
    ...
    var search_name= '<?php echo $_POST["name"]; ?>';
...
continue;}
if(is_product(search_temp)==false){
continue;}
