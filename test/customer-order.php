 ...
 _________________________________________________________ -->
    <div id="top">
        <div class="container">
            ...
            <div class="col-md-6" data-animate="fadeInDown" id="ba" >
                <ul class="menu">
     <?php  
...
<?php
 ...
 _________________________________________________________ -->
	...
	<?php   
	  ...
	  $sql="select * from order_info where username='{$username}' and order_id='{$id}'";
	  $stmt=oci_parse($connect,$sql);
	  oci_execute($stmt);
...
?>	
                <div class="col-md-9" id="customer-order">
                    <div class="box">
                        ...
                        <p class="lead">Order #<?php echo $id;?> was placed on <strong><?php echo $dd[0]; ?></strong> and is currently <strong>Being prepared</strong>.</p>
	...
	<?php   
	  ...
	  $sql="select * from product_detail where username='{$username}' and order_id='{$id}'";
	  $stmt=oci_parse($connect,$sql);
	  oci_execute($stmt);
	         $name=array();
             $src=array();			 
...
?>							
     ...
     $connect=oci_connect("liteng", "Li86459451","SSID");
     $sql="select * from ORDERSUMMAY where email='{$username}'" ;
     $stmt=oci_parse($connect, $sql);
     oci_execute($stmt);
...
?>                          
                                <tfoot>
                                    <tr>
                                        <td colspan="5" class="text-right">Order subtotal</td>
                                        <th>$<?php echo $subtotal[0]; ?></th>
                                    </tr>
                                    <tr>
                                        <td colspan="5" class="text-right">Shipping and handling</td>
                                        <th>$<span id='ship'><?php echo $ship[0]; ?></span></th>
                                    </tr>
                                    <tr>
                                        <td colspan="5" class="text-right">GST 10%</td>
     ...
     ?>                   <!-- /.table-responsive -->
                        ...
                        <div class="row addresses">
                            <div class="col-md-6">
                                <h2 class=text-center>Invoice address</h2>

                                <p><input type="text" class="form-control" value=' <?php echo $firstname[0]; ?><?php echo $lastname[0]; ?>'>
                                    <br><input type="text" class="form-control" value=' <?php echo $address[0]; ?>'>
                                    <br><input type="text" class="form-control" value=' <?php echo $company[0]; ?>'>
                                    <br><input type="text" class="form-control" value=' <?php echo $postcode[0]; ?>'>
                                    <br><input type="text" class="form-control" value=' <?php echo $state[0]; ?>'></p>
                            </div>
                            <div class="col-md-6">
